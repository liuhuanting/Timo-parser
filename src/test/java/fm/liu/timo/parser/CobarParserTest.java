...
public class CobarParserTest {
	...
	public void parseWithoutDelegateClass() throws Exception {
		System.out.println();
		String sql = "select t1.name,t2.productid,t3.name from customer t1,orderlist t2,product t3 where t1.id=t2.customerid and t2.productid=t3.id;";
	...
	public void perfSql() throws SQLSyntaxErrorException {
		...
		System.out.println("Cobar parse use " + millis + "ms,every use "
				+ millis * 1000 / Count);
	}
}
