...
public class LiteralHexadecimalTest extends TestCase {
	public void testUtf8() throws Exception {
		String sql = "x'E783ADE7929E275C73'";
		LiteralHexadecimal hex = (LiteralHexadecimal) new MySQLExprParser(
				new MySQLLexer(sql), "utf-8").expression();
		Assert.assertEquals("热璞'\\s", hex.evaluation(null));

		sql = "x'd0A'";
		hex = (LiteralHexadecimal) new MySQLExprParser(new MySQLLexer(sql),
				"utf-8").expression();
		Assert.assertEquals("\r\n", hex.evaluation(null));
	}
