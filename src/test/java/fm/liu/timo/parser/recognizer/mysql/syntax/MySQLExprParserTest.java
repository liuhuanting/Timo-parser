...
public class MySQLExprParserTest extends AbstractSyntaxTest {
	...
	public void testExpr1() throws Exception {
		...
		BinaryOperatorExpression bex = (BinaryOperatorExpression) ((ArithmeticAddExpression) expr)
				.getRightOprand();
		...
		bex = (BinaryOperatorExpression) ((LogicalAndExpression) expr)
				.getOperand(0);
		Assert.assertEquals(ArithmeticModExpression.class, bex.getClass());
		bex = (BinaryOperatorExpression) ((ArithmeticModExpression) bex)
				.getLeftOprand();
		Assert.assertEquals(ArithmeticMultiplyExpression.class, bex.getClass());
		bex = (BinaryOperatorExpression) ((ArithmeticMultiplyExpression) bex)
				.getLeftOprand();
		...
		bex = (BinaryOperatorExpression) ((ArithmeticAddExpression) bex)
				.getRightOprand();
		Assert.assertEquals(ArithmeticDivideExpression.class, bex.getClass());
		...
		TernaryOperatorExpression tex = (TernaryOperatorExpression) ((LogicalNotExpression) expr)
				.getOperand();
		...
		Assert.assertEquals(LogicalAndExpression.class, tex.getSecond()
				.getClass());
		Assert.assertEquals(BitOrExpression.class, tex.getThird().getClass());
		tex = (TernaryOperatorExpression) ((BetweenAndExpression) tex)
				.getFirst();
		Assert.assertEquals(InExpression.class, tex.getFirst().getClass());
		Assert.assertEquals(ArithmeticIntegerDivideExpression.class, tex
				.getSecond().getClass());
		bex = (BinaryOperatorExpression) (InExpression) tex.getFirst();
		Assert.assertEquals(NegativeValueExpression.class, bex.getLeftOprand()
				.getClass());
		Assert.assertEquals(InExpressionList.class, bex.getRightOprand()
				.getClass());
		UnaryOperatorExpression uex = (UnaryOperatorExpression) ((NegativeValueExpression) bex
				.getLeftOprand());
		Assert.assertEquals(BitInvertExpression.class, uex.getOperand()
				.getClass());
		...
		Assert.assertEquals(ComparisionIsExpression.class, bex.getLeftOprand()
				.getClass());
		Assert.assertEquals(Identifier.class, bex.getRightOprand().getClass());
		ComparisionIsExpression cex = (ComparisionIsExpression) bex
				.getLeftOprand();
		Assert.assertEquals(CastBinaryExpression.class, cex.getOperand()
				.getClass());
		uex = (UnaryOperatorExpression) cex.getOperand();
		Assert.assertEquals(CaseWhenOperatorExpression.class, uex.getOperand()
				.getClass());
		CaseWhenOperatorExpression cwex = (CaseWhenOperatorExpression) uex
				.getOperand();
		Assert.assertEquals(LogicalOrExpression.class, cwex.getComparee()
				.getClass());
		PolyadicOperatorExpression pex = (LogicalOrExpression) cwex
				.getComparee();
		Assert.assertEquals(BitInvertExpression.class, pex.getOperand(0)
				.getClass());
		Assert.assertEquals(LogicalXORExpression.class, pex.getOperand(1)
				.getClass());
		bex = (LogicalXORExpression) pex.getOperand(1);
		Assert.assertEquals(LogicalAndExpression.class, bex.getLeftOprand()
				.getClass());
		Assert.assertEquals(Identifier.class, bex.getRightOprand().getClass());
		pex = (LogicalAndExpression) bex.getLeftOprand();
		Assert.assertEquals(Identifier.class, pex.getOperand(0).getClass());
		Assert.assertEquals(BitXORExpression.class, pex.getOperand(1)
				.getClass());
		...
		Assert.assertEquals(ComparisionNotEqualsExpression.class, pex
				.getOperand(0).getClass());
		Assert.assertEquals(SoundsLikeExpression.class, pex.getOperand(1)
				.getClass());
		bex = (BinaryOperatorExpression) pex.getOperand(0);
		Assert.assertEquals(ComparisionNullSafeEqualsExpression.class, bex
				.getLeftOprand().getClass());
		Assert.assertEquals(SysVarPrimary.class, bex.getRightOprand()
				.getClass());
		bex = (BinaryOperatorExpression) bex.getLeftOprand();
		Assert.assertEquals(NegativeValueExpression.class, bex.getLeftOprand()
				.getClass());
		Assert.assertEquals(BitShiftExpression.class, bex.getRightOprand()
				.getClass());
		bex = (BinaryOperatorExpression) bex.getRightOprand();
		Assert.assertEquals(Identifier.class, bex.getLeftOprand().getClass());
		Assert.assertEquals(ArithmeticAddExpression.class, bex.getRightOprand()
				.getClass());
		bex = (BinaryOperatorExpression) bex.getRightOprand();
		Assert.assertEquals(ArithmeticDivideExpression.class, bex
				.getLeftOprand().getClass());
		Assert.assertEquals(Identifier.class, bex.getRightOprand().getClass());
		bex = (BinaryOperatorExpression) bex.getLeftOprand();
		Assert.assertEquals(CollateExpression.class, bex.getLeftOprand()
				.getClass());
		Assert.assertEquals(ParamMarker.class, bex.getRightOprand().getClass());
		bex = (BinaryOperatorExpression) ((LogicalOrExpression) expr)
				.getOperand(1);
		Assert.assertEquals(UsrDefVarPrimary.class, bex.getLeftOprand()
				.getClass());
		Assert.assertEquals(ArithmeticModExpression.class, bex.getRightOprand()
				.getClass());
		bex = (BinaryOperatorExpression) bex.getRightOprand();
		Assert.assertEquals(MinusExpression.class, bex.getLeftOprand()
				.getClass());
		Assert.assertEquals(MinusExpression.class, bex.getRightOprand()
				.getClass());
		uex = (UnaryOperatorExpression) bex.getLeftOprand();
		Assert.assertEquals(ArithmeticSubtractExpression.class, uex
				.getOperand().getClass());
		uex = (UnaryOperatorExpression) bex.getRightOprand();
		Assert.assertEquals(LogicalOrExpression.class, uex.getOperand()
				.getClass());
	}
	...
	// Assert.assertEquals(AssignmentExpression.class, ass.getRightOprand()
	// .getClass());
	...
	// Assert.assertEquals(ComparisionEqualsExpression.class, expr.getClass());
	// ass = (AssignmentExpression) ((BinaryOperatorExpression) expr)
	// .getRightOprand();
	...
	// expr = parser.expression();
	// output = output2MySQL(expr, sql);
	// Assert.assertEquals("a := b OR c AND d := b'1101' OR b'01' & x'abc'",
	// output);
	// Assert.assertEquals(AssignmentExpression.class, expr.getClass());
	...
	// .getClass());
	// ass = (AssignmentExpression) ass.getRightOprand();
	// Assert.assertEquals(LogicalOrExpression.class, ass.getLeftOprand()
	// .getClass());
	// Assert.assertEquals(LogicalOrExpression.class, ass.getRightOprand()
	// .getClass());
	// LogicalOrExpression lor = (LogicalOrExpression) ass.getLeftOprand();
	// Assert.assertEquals(LogicalAndExpression.class, lor.getOperand(1)
	// .getClass());
	// lor = (LogicalOrExpression) ass.getRightOprand();
	// Assert.assertEquals(LiteralBitField.class, lor.getOperand(0).getClass());
	// Assert.assertEquals(BitAndExpression.class, lor.getOperand(1)
	// .getClass());
	//
	// sql = "a:=((b or (c &&d)) :=((0b1101 or (b'01'&0xabc))))";
	// parser = new MySQLExprParser(new MySQLLexer(sql));
	...
	// output = output2MySQL(expr, sql);
	// Assert.assertEquals(
	// "(a := b) OR c AND (d := b'1101' OR b'01') & x'abc' ^ NULL",
	// output);
	// Assert.assertEquals(LogicalOrExpression.class, expr.getClass());
	// lor = (LogicalOrExpression) expr;
	// Assert.assertEquals(AssignmentExpression.class, lor.getOperand(0)
	// .getClass());
	// Assert.assertEquals(LogicalAndExpression.class, lor.getOperand(1)
	// .getClass());
	...
	// Assert.assertEquals(BitAndExpression.class, land.getOperand(1)
	// .getClass());
	// BitAndExpression band = (BitAndExpression) land.getOperand(1);
	// Assert.assertEquals(AssignmentExpression.class, band.getLeftOprand()
	// .getClass());
	// Assert.assertEquals(BitXORExpression.class, band.getRightOprand()
	// .getClass());
	// ass = (AssignmentExpression) band.getLeftOprand();
	// Assert.assertEquals(LogicalOrExpression.class, ass.getRightOprand()
	// .getClass());
	// BitXORExpression bxor = (BitXORExpression) band.getRightOprand();
	// Assert.assertEquals(LiteralHexadecimal.class, bxor.getLeftOprand()
	// .getClass());
	...
	public void testLogical() throws Exception {
		...
		Assert.assertEquals(LogicalXORExpression.class, xor.getLeftOprand()
				.getClass());
		xor = (LogicalXORExpression) xor.getLeftOprand();
		Assert.assertEquals("b",
				((Identifier) xor.getRightOprand()).getIdText());
		...
		Assert.assertEquals("b",
				((Identifier) xor2.getLeftOprand()).getIdText());
		Assert.assertEquals("c",
				((Identifier) xor2.getRightOprand()).getIdText());
		...
		Assert.assertEquals(LogicalNotExpression.class, expr.getClass());
		LogicalNotExpression not = (LogicalNotExpression) ((LogicalNotExpression) expr)
				.getOperand();
	...
	public void testComparision() throws Exception {
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"a BETWEEN b BETWEEN c AND d AND e BETWEEN f AND g", output);
		...
		expr = parser.expression();
		output = output2MySQL(expr, sql);
		Assert.assertEquals("(SELECT a) BETWEEN (SELECT b) AND (SELECT d)",
				output);
		...
		Assert.assertEquals("b",
				((Identifier) re2.getRightOprand()).getIdText());
		...
		expr = parser.expression();
		output = output2MySQL(expr, sql);
		Assert.assertEquals("(SELECT a) LIKE (SELECT b) ESCAPE (SELECT d)",
				output);
		...
		Assert.assertTrue(QueryExpression.class.isAssignableFrom(in
				.getRightOprand().getClass()));
		...
		ComparisionIsExpression is3 = (ComparisionIsExpression) is2
				.getOperand();
		ComparisionIsExpression is4 = (ComparisionIsExpression) is3
				.getOperand();
		ComparisionIsExpression is5 = (ComparisionIsExpression) is4
				.getOperand();
		ComparisionIsExpression is6 = (ComparisionIsExpression) is5
				.getOperand();
		ComparisionIsExpression is7 = (ComparisionIsExpression) is6
				.getOperand();
		ComparisionIsExpression is8 = (ComparisionIsExpression) is7
				.getOperand();
		...
		Assert.assertEquals(ComparisionIsExpression.IS_NOT_UNKNOWN,
				is5.getMode());
		...
		ComparisionLessOrGreaterThanExpression lg = (ComparisionLessOrGreaterThanExpression) neq
				.getLeftOprand();
		ComparisionLessThanExpression l = (ComparisionLessThanExpression) lg
				.getLeftOprand();
		ComparisionLessThanOrEqualsExpression leq = (ComparisionLessThanOrEqualsExpression) l
				.getLeftOprand();
		ComparisionGreaterThanExpression g = (ComparisionGreaterThanExpression) leq
				.getLeftOprand();
		ComparisionGreaterThanOrEqualsExpression geq = (ComparisionGreaterThanOrEqualsExpression) g
				.getLeftOprand();
		ComparisionNullSafeEqualsExpression nseq = (ComparisionNullSafeEqualsExpression) geq
				.getLeftOprand();
		ComparisionEqualsExpression eq = (ComparisionEqualsExpression) nseq
				.getLeftOprand();
		Assert.assertEquals("i",
				((Identifier) neq.getRightOprand()).getIdText());
		...
		Assert.assertEquals("f",
				((Identifier) leq.getRightOprand()).getIdText());
		Assert.assertEquals("e", ((Identifier) g.getRightOprand()).getIdText());
		Assert.assertEquals("d",
				((Identifier) geq.getRightOprand()).getIdText());
		Assert.assertEquals("c",
				((Identifier) nseq.getRightOprand()).getIdText());
		...
		Assert.assertEquals("b",
				((Identifier) sl2.getRightOprand()).getIdText());
	...
	public void testBit() throws Exception {
		...
		ArithmeticAddExpression add = (ArithmeticAddExpression) and
				.getLeftOprand();
		ArithmeticSubtractExpression sub = (ArithmeticSubtractExpression) and
				.getRightOprand();
		BitXORExpression xor = (BitXORExpression) sub.getLeftOprand();
		Assert.assertEquals("d",
				((Identifier) xor.getRightOprand()).getIdText());
		Assert.assertEquals("b",
				((Identifier) add.getRightOprand()).getIdText());
	}
	...
	public void testArithmetic() throws Exception {
		...
		Expression expr = parser.expression();
		String output = output2MySQL(expr, sql);
		Assert.assertEquals("? + @usrVar1 * c / @@version - e % - f DIV g",
				output);
		ArithmeticSubtractExpression sub = (ArithmeticSubtractExpression) expr;
		ArithmeticAddExpression add = (ArithmeticAddExpression) sub
				.getLeftOprand();
		ArithmeticIntegerDivideExpression idiv = (ArithmeticIntegerDivideExpression) sub
				.getRightOprand();
		ArithmeticModExpression mod = (ArithmeticModExpression) idiv
				.getLeftOprand();
		ArithmeticDivideExpression div = (ArithmeticDivideExpression) add
				.getRightOprand();
		ArithmeticMultiplyExpression mt = (ArithmeticMultiplyExpression) div
				.getLeftOprand();
		...
		expr = parser.expression();
		output = output2MySQL(expr, sql);
		Assert.assertEquals("a + b % - ((SELECT id FROM t1 LIMIT 0 , 1) - e)",
				output);
		...
		Assert.assertTrue(QueryExpression.class.isAssignableFrom(sub
				.getLeftOprand().getClass()));
		Assert.assertEquals("e",
				((Identifier) sub.getRightOprand()).getIdText());
	...
	public void testAnyAll() throws Exception {
		...
		Assert.assertEquals(ComparisionGreaterThanOrEqualsExpression.class,
				expr.getClass());
		...
		ComparisionGreaterThanOrEqualsExpression ge = (ComparisionGreaterThanOrEqualsExpression) gt
				.getLeftOprand();
	...
	public void testPrimary() throws Exception {
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"CASE v1 WHEN `index` THEN a WHEN 2 THEN b ELSE c END", output);
	...
	public void testStartedFromIdentifier() throws Exception {
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"GROUP_CONCAT(DISTINCT test_score ORDER BY test_score ASC SEPARATOR ',')",
				output);
	...
	public void testInterval() throws Exception {
		...
		String output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"DATE_ADD('2009-01-01', INTERVAL (6 / 4) HOUR_MINUTE)", output);
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"DATE_ADD('2100-12-31 23:59:59', INTERVAL '1:1:1' HOUR_SECOND)",
				output);
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"DATE_ADD('2100-12-31 23:59:59', INTERVAL '1 1:1' DAY_MINUTE)",
				output);
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"DATE_ADD('2100-12-31', INTERVAL '1-1' YEAR_MONTH)", output);
	...
	public void testMatchExpression() throws Exception {
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"MATCH (title, body) AGAINST ((abc IN (d)) IN BOOLEAN MODE)",
				output);
		...
		// output = output2MySQL(expr, sql);
		// Assert.assertEquals(
		// "MATCH (col1, col2, col3) AGAINST (a := b := c IN BOOLEAN MODE)",
		// output);
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"MATCH (title, body) AGAINST (a AND (b OR c) IN BOOLEAN MODE)",
				output);
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"MATCH (title, body) AGAINST (a BETWEEN b AND c IN BOOLEAN MODE)",
				output);
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"MATCH (title, body) AGAINST (NOT NOT a IN BOOLEAN MODE)",
				output);
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"MATCH (title, body) AGAINST (a IS TRUE IN BOOLEAN MODE)",
				output);
		...
		output = output2MySQL(expr, sql);
		Assert.assertEquals(
				"MATCH (title, body) AGAINST (SELECT a IN BOOLEAN MODE)",
				output);
