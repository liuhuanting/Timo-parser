...
public class MySQLLexerTest extends TestCase {
	...
	public void testHexBit() throws SQLSyntaxErrorException {
		...
		Assert.assertEquals(
				"123",
				new String(sut.getSQL(), sut.getOffsetCache(), sut
						.getSizeCache()));
		sut.nextToken();
		Assert.assertEquals(MySQLToken.EOF, sut.token());
		...
		Assert.assertEquals(MySQLToken.LITERAL_HEX, sut.token());
		Assert.assertEquals("0", new String(sut.getSQL(), sut.getOffsetCache(),
				sut.getSizeCache()));
		sut.nextToken();
		Assert.assertEquals(MySQLToken.EOF, sut.token());
		...
		sut = new MySQLLexer(
				"\r 0xabc.123;x'e'a0x1.3x'a2w'--\t0b11\n0b12*b '123' b'101'");
		Assert.assertEquals(MySQLToken.LITERAL_HEX, sut.token());
		Assert.assertEquals(
				"abc",
				new String(sut.getSQL(), sut.getOffsetCache(), sut
		...
		sut.nextToken();
		Assert.assertEquals(MySQLToken.LITERAL_HEX, sut.token());
		Assert.assertEquals("e", new String(sut.getSQL(), sut.getOffsetCache(),
				sut.getSizeCache()));
		sut.nextToken();
		Assert.assertEquals(MySQLToken.IDENTIFIER, sut.token());
	...
	public void testNumber() throws SQLSyntaxErrorException {
		...
		sut = new MySQLLexer(
				"12345678901234567890123 1234567890 1234567890123456789");
		Assert.assertEquals(MySQLToken.LITERAL_NUM_PURE_DIGIT, sut.token());
		Assert.assertEquals("12345678901234567890123",
				String.valueOf(sut.integerValue()));
		sut.nextToken();
		Assert.assertEquals(MySQLToken.LITERAL_NUM_PURE_DIGIT, sut.token());
		Assert.assertEquals("1234567890", String.valueOf(sut.integerValue()));
		sut.nextToken();
		Assert.assertEquals(MySQLToken.LITERAL_NUM_PURE_DIGIT, sut.token());
		Assert.assertEquals("1234567890123456789",
				String.valueOf(sut.integerValue()));
		sut.nextToken();
		Assert.assertEquals(MySQLToken.EOF, sut.token());
	...
	public void testCStyleComment() throws SQLSyntaxErrorException {
		...
		version = MySQLLexer.setCStyleCommentVersion(40000);
		sut = new MySQLLexer(
				"id1 /*!40000/*/*/id2*//*!40001 id4*//*!40001 id5*/ id3");
		Assert.assertEquals(MySQLToken.IDENTIFIER, sut.token());
		Assert.assertEquals("id1", sut.stringValue());
		sut.nextToken();
		Assert.assertEquals(MySQLToken.IDENTIFIER, sut.token());
		...
		version = MySQLLexer.setCStyleCommentVersion(40000);
		sut = new MySQLLexer(
				"id1 /*!40000/*/*/id2*//*!40001 id4*//*!40000id5*/ id3");
		Assert.assertEquals(MySQLToken.IDENTIFIER, sut.token());
		Assert.assertEquals("id1", sut.stringValue());
		sut.nextToken();
		Assert.assertEquals(MySQLToken.IDENTIFIER, sut.token());
