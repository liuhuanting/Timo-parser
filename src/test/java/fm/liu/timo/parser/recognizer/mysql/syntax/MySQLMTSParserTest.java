...
public class MySQLMTSParserTest extends AbstractSyntaxTest {
	...
	public void testRollback() throws SQLSyntaxErrorException {
		...
		Assert.assertEquals(MTSRollbackStatement.CompleteType.UN_DEF,
		...
		Assert.assertEquals(MTSRollbackStatement.CompleteType.NO_CHAIN,
				rollback.getCompleteType());
		Assert.assertNull(rollback.getSavepoint());
		...
		Assert.assertEquals(MTSRollbackStatement.CompleteType.CHAIN,
				rollback.getCompleteType());
		Assert.assertNull(rollback.getSavepoint());
		...
		Assert.assertEquals(MTSRollbackStatement.CompleteType.RELEASE,
				rollback.getCompleteType());
		Assert.assertNull(rollback.getSavepoint());
