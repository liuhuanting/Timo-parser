...
public class MySQLFunctionManager {
	...
	public MySQLFunctionManager(boolean allowFuncDefChange) {
		...
		parsingStrateg
				.put("EXTERIORRING", FunctionParsingStrategy.EXTERIORRING);
		parsingStrateg.put("GEOMCOLLFROMTEXT",
				FunctionParsingStrategy.GEOMCOLLFROMTEXT);
		parsingStrateg.put("GEOMETRYCOLLECTIONFROMTEXT",
				FunctionParsingStrategy.GEOMETRYCOLLECTIONFROMTEXT);
		parsingStrateg.put("GEOMCOLLFROMWKB",
				FunctionParsingStrategy.GEOMCOLLFROMWKB);
		parsingStrateg.put("GEOMETRYCOLLECTIONFROMWKB",
				FunctionParsingStrategy.GEOMETRYCOLLECTIONFROMWKB);
		parsingStrateg.put("GEOMETRYCOLLECTION",
				FunctionParsingStrategy.GEOMETRYCOLLECTION);
		parsingStrateg.put("GEOMETRYN", FunctionParsingStrategy.GEOMETRYN);
		parsingStrateg
				.put("GEOMETRYTYPE", FunctionParsingStrategy.GEOMETRYTYPE);
		parsingStrateg
				.put("GEOMFROMTEXT", FunctionParsingStrategy.GEOMFROMTEXT);
		parsingStrateg.put("GEOMETRYFROMTEXT",
				FunctionParsingStrategy.GEOMETRYFROMTEXT);
		...
		parsingStrateg.put("INTERIORRINGN",
				FunctionParsingStrategy.INTERIORRINGN);
		...
		parsingStrateg
				.put("LINEFROMTEXT", FunctionParsingStrategy.LINEFROMTEXT);
		parsingStrateg.put("LINEFROMWKB", FunctionParsingStrategy.LINEFROMWKB);
		parsingStrateg.put("LINESTRINGFROMWKB",
				FunctionParsingStrategy.LINESTRINGFROMWKB);
		...
		parsingStrateg.put("MBRINTERSECTS",
				FunctionParsingStrategy.MBRINTERSECTS);
		...
		parsingStrateg.put("MLINEFROMTEXT",
				FunctionParsingStrategy.MLINEFROMTEXT);
		parsingStrateg.put("MULTILINESTRINGFROMTEXT",
				FunctionParsingStrategy.MULTILINESTRINGFROMTEXT);
		parsingStrateg
				.put("MLINEFROMWKB", FunctionParsingStrategy.MLINEFROMWKB);
		parsingStrateg.put("MULTILINESTRINGFROMWKB",
				FunctionParsingStrategy.MULTILINESTRINGFROMWKB);
		parsingStrateg.put("MPOINTFROMTEXT",
				FunctionParsingStrategy.MPOINTFROMTEXT);
		parsingStrateg.put("MULTIPOINTFROMTEXT",
				FunctionParsingStrategy.MULTIPOINTFROMTEXT);
		parsingStrateg.put("MPOINTFROMWKB",
				FunctionParsingStrategy.MPOINTFROMWKB);
		parsingStrateg.put("MULTIPOINTFROMWKB",
				FunctionParsingStrategy.MULTIPOINTFROMWKB);
		parsingStrateg.put("MPOLYFROMTEXT",
				FunctionParsingStrategy.MPOLYFROMTEXT);
		parsingStrateg.put("MULTIPOLYGONFROMTEXT",
				FunctionParsingStrategy.MULTIPOLYGONFROMTEXT);
		parsingStrateg
				.put("MPOLYFROMWKB", FunctionParsingStrategy.MPOLYFROMWKB);
		parsingStrateg.put("MULTIPOLYGONFROMWKB",
				FunctionParsingStrategy.MULTIPOLYGONFROMWKB);
		parsingStrateg.put("MULTILINESTRING",
				FunctionParsingStrategy.MULTILINESTRING);
		parsingStrateg.put("MULTIPOINT", FunctionParsingStrategy.MULTIPOINT);
		parsingStrateg
				.put("MULTIPOLYGON", FunctionParsingStrategy.MULTIPOLYGON);
		parsingStrateg.put("NUMGEOMETRIES",
				FunctionParsingStrategy.NUMGEOMETRIES);
		parsingStrateg.put("NUMINTERIORRINGS",
				FunctionParsingStrategy.NUMINTERIORRINGS);
		...
		parsingStrateg.put("POINTFROMTEXT",
				FunctionParsingStrategy.POINTFROMTEXT);
		parsingStrateg
				.put("POINTFROMWKB", FunctionParsingStrategy.POINTFROMWKB);
		parsingStrateg.put("POINTN", FunctionParsingStrategy.POINTN);
		parsingStrateg
				.put("POLYFROMTEXT", FunctionParsingStrategy.POLYFROMTEXT);
		parsingStrateg.put("POLYGONFROMTEXT",
				FunctionParsingStrategy.POLYGONFROMTEXT);
		parsingStrateg.put("POLYFROMWKB", FunctionParsingStrategy.POLYFROMWKB);
		parsingStrateg.put("POLYGONFROMWKB",
				FunctionParsingStrategy.POLYGONFROMWKB);
		...
		parsingStrateg.put("ST_DIFFERENCE",
				FunctionParsingStrategy.ST_DIFFERENCE);
		...
		parsingStrateg.put("ST_INTERSECTION",
				FunctionParsingStrategy.ST_INTERSECTION);
		parsingStrateg.put("ST_INTERSECTS",
				FunctionParsingStrategy.ST_INTERSECTS);
		parsingStrateg.put("ST_OVERLAPS", FunctionParsingStrategy.ST_OVERLAPS);
		parsingStrateg.put("ST_SYMDIFFERENCE",
				FunctionParsingStrategy.ST_SYMDIFFERENCE);
		...
		parsingStrateg
				.put("GROUP_CONCAT", FunctionParsingStrategy.GROUP_CONCAT);
		...
		parsingStrateg
				.put("TIMESTAMPADD", FunctionParsingStrategy.TIMESTAMPADD);
		parsingStrateg.put("TIMESTAMPDIFF",
				FunctionParsingStrategy.TIMESTAMPDIFF);
		...
		functionPrototype.put("UNCOMPRESSED_LENGTH", new UncompressedLength(
				null));
	...
	/**
	 * @param extFuncPrototypeMap
	 *            funcName -&gt; extFunctionPrototype. funcName MUST NOT be the
	 *            same as predefined function of MySQL 5.5
	...
	public synchronized void addExtendFunction(
		...
		if (!allowFuncDefChange) {
			throw new UnsupportedOperationException(
					"function define is not allowed to be changed");
		}

		Map<String, FunctionExpression> toPut = new HashMap<String, FunctionExpression>();
		// check extFuncPrototypeMap
		for (Entry<String, FunctionExpression> en : extFuncPrototypeMap
				.entrySet()) {
