...
public class ExprEvalUtils {
	...
	public static Number calculate(UnaryOperandCalculator cal, Number num) {
		...
		throw new IllegalArgumentException("unsupported add calculate: "
				+ num.getClass());
	}

	public static Number calculate(BinaryOperandCalculator cal, Number n1,
			Number n2) {
		if (n1 == null || n2 == null)
			return null;
	...
	/**
	 * @param obj1
	 *            class of String or Number
	 */
	public static Pair<Number, Number> convertNum2SameLevel(Object obj1,
			Object obj2) {
		Number n1, n2;
	...
	private static Number upTolevel(Number num, int level) {
		...
		default:
			throw new IllegalArgumentException("unsupported number level: "
					+ level);
		}
	}
	...
	public static Number string2Number(String str) {
		...
		try {
			...
			default:
				throw new IllegalArgumentException("unrecognized number: "
						+ str);
			}
