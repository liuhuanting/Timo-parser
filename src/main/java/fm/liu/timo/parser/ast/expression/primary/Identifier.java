...
public class Identifier extends PrimaryExpression implements Cloneable {
	 ...
	 * @param trimSchema
	 *            upper-case. Assumed that top trimmed parent is schema, if that
	 *            equals given schema, do not trim
	...
	public int trimParent(int level, String trimSchema) {
		...
		if (trimSchema != null
				&& !trimSchema.equals(id.parent.idTextUpUnescape)) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Identifier) {
			...
			return objEquals(this.parent, that.parent)
					&& objEquals(this.idText, that.idText);
		}
		return false;
	}
