 ...
 */
public class InExpression extends BinaryOperatorExpression implements
		ReplacableExpression {
	private final boolean not;

	/**
	 * @param rightOprand
	 *            {@link QueryExpression} or {@link InExpressionList}
	 */
	public InExpression(boolean not, Expression leftOprand,
